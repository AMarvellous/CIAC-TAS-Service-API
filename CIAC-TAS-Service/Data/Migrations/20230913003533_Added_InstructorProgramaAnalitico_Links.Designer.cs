...
namespace CIACTASService.Data.Migrations
{
    ...
    [Migration("20230913003533_Added_InstructorProgramaAnalitico_Links")]
    partial class Added_InstructorProgramaAnalitico_Links
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CIAC_TAS_Service.Domain.InstructorDomain.InstructorProgramaAnalitico", b =>
                {
                    ...
                    b.Property<int>("ProgramaAnaliticoId")
                        .HasColumnType("int");

                    b.HasKey("InstructorId", "ProgramaAnaliticoId");
            ...
            modelBuilder.Entity("InstructorInstructorProgramaAnalitico", b =>
                {
                    b.Property<int>("InstructoresId")
                        .HasColumnType("int");

                    b.Property<int>("InstructorProgramaAnaliticosInstructorId")
                        .HasColumnType("int");

                    b.Property<int>("InstructorProgramaAnaliticosProgramaAnaliticoId")
                        .HasColumnType("int");

                    b.HasKey("InstructoresId", "InstructorProgramaAnaliticosInstructorId", "InstructorProgramaAnaliticosProgramaAnaliticoId");

                    b.HasIndex("InstructorProgramaAnaliticosInstructorId", "InstructorProgramaAnaliticosProgramaAnaliticoId");

                    b.ToTable("InstructorInstructorProgramaAnalitico");
                });

            modelBuilder.Entity("InstructorProgramaAnaliticoProgramaAnaliticoPdf", b =>
                {
                    b.Property<int>("ProgramaAnaliticoPdfsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProgramaAnaliticoPdfsId", "InstructorProgramaAnaliticosInstructorId", "InstructorProgramaAnaliticosProgramaAnaliticoId");

                    b.HasIndex("InstructorProgramaAnaliticosInstructorId", "InstructorProgramaAnaliticosProgramaAnaliticoId");

                    b.ToTable("InstructorProgramaAnaliticoProgramaAnaliticoPdf");
                });
            ...
            modelBuilder.Entity("InstructorInstructorProgramaAnalitico", b =>
                {
                    b.HasOne("CIAC_TAS_Service.Domain.General.Instructor", null)
                        .WithMany()
                        .HasForeignKey("InstructoresId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CIAC_TAS_Service.Domain.InstructorDomain.InstructorProgramaAnalitico", null)
                        .WithMany()
                        .HasForeignKey("InstructorProgramaAnaliticosInstructorId", "InstructorProgramaAnaliticosProgramaAnaliticoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("InstructorProgramaAnaliticoProgramaAnaliticoPdf", b =>
                {
                    b.HasOne("CIAC_TAS_Service.Domain.General.ProgramaAnaliticoPdf", null)
                        .WithMany()
                        .HasForeignKey("ProgramaAnaliticoPdfsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
