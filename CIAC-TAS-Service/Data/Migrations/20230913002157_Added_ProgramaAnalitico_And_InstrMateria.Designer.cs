...
namespace CIACTASService.Data.Migrations
{
    ...
    [Migration("20230913002157_Added_ProgramaAnalitico_And_InstrMateria")]
    partial class Added_ProgramaAnalitico_And_InstrMateria
    {
            ...
            modelBuilder.Entity("CIAC_TAS_Service.Domain.General.Instructor", b =>
                {
                    ...
                    b.Property<int?>("InstructorProgramaAnaliticoInstructorId")
                        .HasColumnType("int");

                    b.Property<int?>("InstructorProgramaAnaliticoProgramaAnaliticoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InstructorProgramaAnaliticoInstructorId", "InstructorProgramaAnaliticoProgramaAnaliticoId");
            ...
            modelBuilder.Entity("CIAC_TAS_Service.Domain.General.Instructor", b =>
                {
                    ...
                    b.HasOne("CIAC_TAS_Service.Domain.InstructorDomain.InstructorProgramaAnalitico", null)
                        ...
                        .HasForeignKey("InstructorProgramaAnaliticoInstructorId", "InstructorProgramaAnaliticoProgramaAnaliticoId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CIAC_TAS_Service.Domain.General.ProgramaAnaliticoPdf", b =>
                {
                    ...
                    b.HasOne("CIAC_TAS_Service.Domain.InstructorDomain.InstructorProgramaAnalitico", null)
                        .WithMany("ProgramaAnaliticoPdfs")
                        .HasForeignKey("InstructorProgramaAnaliticoInstructorId", "InstructorProgramaAnaliticoProgramaAnaliticoId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CIAC_TAS_Service.Domain.InstructorDomain.InstructorProgramaAnalitico", b =>
                {
                    ...
                    b.Navigation("ProgramaAnaliticoPdfs");
                });
