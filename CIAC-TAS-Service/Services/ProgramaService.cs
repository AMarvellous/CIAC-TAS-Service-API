...
namespace CIAC_TAS_Service.Services
{
    public class ProgramaService : IProgramaService
    {
        ...
        {
            var queryable = _dataContext.Programas.AsQueryable();
        ...
        {
            return await _dataContext.Programas.SingleOrDefaultAsync(x => x.Id == id);
        }

        public async Task<bool> CreateProgramaAsync(Programa programa)
        {
            await _dataContext.Programas.AddAsync(programa);
        ...
        {
            _dataContext.Programas.Update(programa);
        ...
        public async Task<bool> DeleteProgramaAsync(int programaId)
        {
            ...
            _dataContext.Programas.Remove(programa);
