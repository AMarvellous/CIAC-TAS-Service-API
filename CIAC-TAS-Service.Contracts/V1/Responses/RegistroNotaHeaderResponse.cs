...
namespace CIAC_TAS_Service.Contracts.V1.Responses
{
    public class RegistroNotaHeaderResponse
    {
        ...
        public TipoRegistroNotaHeaderResponse TipoRegistroNotaHeader { get; set; }
        public ICollection<RegistroNotaEstudianteHeaderResponse> RegistroNotaEstudianteHeaders { get; set; }
    }
}
